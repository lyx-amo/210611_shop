      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="navlist in floor.navList" :key="navlist.text">
            ...
            <div class="floorBanner">
              <swiper ref="Swiper" :options="swiperOptions">
                <swiper-slide v-for="carousel in floor.carouselList" :key="carousel.id">
                  ...
                  <div class="swiper-button-prev" style="color:red;" slot="button-prev"></div>
                  <div class="swiper-button-next" style="color:red;" slot="button-next"></div>
